...
To make it easy for you to get started with GitLab, here's a list of recommended next steps. Like here
...
```
cd existing_repo
git remote add origin https://git.fse.network/group-a-2022/foodbank-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fse.network/group-a-2022/foodbank-project/-/settings/integrations)
